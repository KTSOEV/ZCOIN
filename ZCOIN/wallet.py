...
SERVER_NODE_URL = "http://localhost:5000"
...
=========================================\n""")
        ...
        addr = "sBdNEcnWGd9rmbx7DMuyqbrNDZCmdBK1d7HdKYRH1XuaFMOTPmCd7hFV/73Xp09JqjWkVs7cGRcTXblEUfi9Nw=="
        res = requests.get(f'{SERVER_NODE_URL}/blocks')
        parsed = json.loads(res.text)
        dump = json.dumps(parsed)
        for ps in parsed:
            dump1 = json.dumps(ps)
            if dump1.find(addr) != -1:
                data = ps['data']
